/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: fb5425db7076ace825cf52e035a9cc92)
// Runtime types generated with workerd@1.20260721.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	IncidentCopilotAgent: DurableObjectNamespace<import("./src/server").IncidentCopilotAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "IncidentCopilotAgent";
	}
